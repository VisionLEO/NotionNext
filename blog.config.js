...
const BLOG = {
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://liuzhenfeng.cn', // 网站地址s
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'PM,Blog,产品经理', // 网站关键词 英文逗号隔开
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || '/favicon.ico', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '鲁ICP备2024089902号', // 备案号 闽ICP备XXXXXX
  ...
  GREETING_WORDS:
    ...
    'Hi👋，I'''m JeffreyLiu. Welcome to My Space🎉.',
